  ...
  const handleSubmit = (e) => {
    ...
    if (formData.email) {
      ...
      if (!emailPattern.test(formData.email)) {
        ...
        const isRegistered = users.some(u => u.email.toLowerCase() === formData.email.toLowerCase()) || 
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden font-body">
      ...
      <div className="w-full max-w-2xl bg-white dark:bg-inverse-surface/5 border border-outline-variant/30 rounded-2xl shadow-xl p-8 backdrop-blur-md relative z-10">
        ...
        {/* Back Link */}
        <Link to="/login" className="inline-flex items-center gap-1.5 text-xs font-label text-on-surface-variant hover:text-primary transition-colors mb-6 group">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-title text-2xl font-bold text-on-surface">Crie sua conta gratuitamente</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="col-span-1 md:col-span-2">
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">Nome Completo</label>
              <input
                type="text"
                name="name"
                value={formData.name}
              ...
              />
              {errors.name && <p className="text-error font-label text-[10px] mt-1">{errors.name}</p>}
            </div>

            {/* CPF */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">CPF</label>
              <input
                type="text"
                name="cpf"
                value={formData.cpf}
              ...
              />
              {errors.cpf && <p className="text-error font-label text-[10px] mt-1">{errors.cpf}</p>}
            </div>

            {/* Data de Nascimento */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">Data de Nascimento</label>
              <input
                type="date"
                name="birthDate"
              ...
              />
              {errors.birthDate && <p className="text-error font-label text-[10px] mt-1">{errors.birthDate}</p>}
            </div>

            {/* Telefone */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">Telefone</label>
              <input
                type="text"
                name="phone"
              ...
              />
              {errors.phone && <p className="text-error font-label text-[10px] mt-1">{errors.phone}</p>}
            </div>

            {/* E-mail */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">E-mail</label>
              <input
                type="text"
                name="email"
              ...
              />
              {errors.email && <p className="text-error font-label text-[10px] mt-1">{errors.email}</p>}
            </div>

            {/* Estado */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">Estado</label>
              <input
                type="text"
                name="state"
              ...
              />
              {errors.state && <p className="text-error font-label text-[10px] mt-1">{errors.state}</p>}
            </div>

            {/* Cidade */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">Cidade</label>
              <input
                type="text"
                name="city"
                value={formData.city}
              ...
              />
              {errors.city && <p className="text-error font-label text-[10px] mt-1">{errors.city}</p>}
            </div>

            {/* Senha */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">Senha</label>
              <input
                type="password"
                name="password"
              ...
              />
              {errors.password && <p className="text-error font-label text-[10px] mt-1">{errors.password}</p>}
            </div>

            {/* Confirmar Senha */}
            <div>
              <label className="font-label text-xs text-on-surface-variant block mb-1 font-bold">Confirmar Senha</label>
              <input
                type="password"
              ...
              />
              {errors.confirmPassword && <p className="text-error font-label text-[10px] mt-1">{errors.confirmPassword}</p>}
            </div>
