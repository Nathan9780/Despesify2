...
export function PlanSelection() {
    ...
    setTimeout(() => {
      ...
      if (usersStr) {
        ...
        const updatedUsers = users.map(u => 
          u.email.toLowerCase() === user.email.toLowerCase() ? { ...u, plan: selectedPlan } : u
        );
  ...
  const plans = [
    ...
    },
    {
      ...
      ideal: 'Ideal para empreendedores e empresas que buscam crescimento e organização.',
      indications: [
    ...
    },
    {
      ...
      badge: 'Investimentos',
      ideal: 'Ideal para pessoas ou organizações interessadas em investir em novos projetos.',
      indications: [
      ...
      <div className="w-full max-w-6xl mx-auto relative z-10">
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex justify-between items-start mb-5">
                    <div className={`w-12 h-12 rounded-xl ${plan.iconBg} flex items-center justify-center shadow-sm`}>
                      <span className="material-symbols-outlined text-[28px]">{plan.icon}</span>
                    </div>
                  ...
                  <h3 className="font-title text-xl font-bold text-on-surface mb-2">{plan.title}</h3>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-1.5">
                      {plan.indications.map((ind, idx) => (
                        <li key={idx} className="flex items-center gap-2 text-xs font-label text-on-surface-variant">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {plan.benefits.map((ben, idx) => (
                        <li key={idx} className="flex items-start gap-2 text-xs font-label text-on-surface">
                ...
                <div className="mt-8 pt-4 border-t border-outline-variant/20 w-full text-center">
                  <span className={`inline-block px-4 py-2 rounded-lg font-label text-xs font-bold transition-colors w-full ${
                    isSelected
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="font-label text-[10px] text-on-surface-variant opacity-60 mt-3">
            Você pode alterar seu plano a qualquer momento na aba de Configurações do seu perfil.
          </p>
        </div>
